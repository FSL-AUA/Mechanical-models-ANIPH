...
This repository contains the machine learning workflow developed in the ANIPH project for predicting mechanical properties of PHBV polymers. Models are developed separately for short-chain-length PHAs (sclPHAs) and medium-chain-length PHAs (mclPHAs).
